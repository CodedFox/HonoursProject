// g++ -o stitch stitch.cpp `pkg-config --libs opencv`
...
{
	// Read input images
	cv::Mat image1= cv::imread("Book1.jpg",0);
	cv::Mat image2= cv::imread("Book2.jpg",0);
	...
	images.push_back(cv::imread("Book1.jpg"));
	images.push_back(cv::imread("Book2.jpg"));
